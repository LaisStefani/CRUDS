 ...
 * @author lalam
 */
public class L_Animal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 20, 120, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L_Animal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
