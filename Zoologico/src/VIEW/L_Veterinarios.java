 ...
 * @author lalam
 */
public class L_Veterinarios extends javax.swing.JFrame {

    /**
     * Creates new form JL_Listar
     */
    public L_Veterinarios() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(15, 20, 200, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L_Veterinarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
